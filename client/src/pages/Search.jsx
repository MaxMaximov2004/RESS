...
export default function Search() {
  ...
  useEffect(() => {
    const urlParams = new URLSearchParams(location.search); // Используем location.search
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              // disabled="disabled"
            >
              <option value="regularPrice_desc">Цена от высокой к низкой</option>
              <option value="regularPrice_asc">Цена от низкой к высокой</option>
      ...
      <div className="flex-1">
        ...
        <div className="p-7 flex flex-wrap gap-4">
          {!loading && listings.length === 0 && (
            <p className="text-xl text-slate-700">Объявления не найдены!</p>
          )}
          {loading && (
